...
labels = [
    ...
    Label(  'sky'                                  ,  9 ,       -1 ,         5 , 'sky'             , 5       , False        , False        , ( 70, 130, 180) ),
    Label(  'occlusion'                        ,    100 ,       -1,          6, 'occlusion'       , 10       , False        , False        , (  140, 140, 140) ),
    Label(  'human.pedestrian.adult'               , 10 ,        2,          7 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'human.pedestrian.child'               , 11 ,        3,          7 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'human.pedestrian.construction_worker' , 12 ,        4,          7 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'human.pedestrian.personal_mobility'   , 13 ,        5,          7 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'human.pedestrian.police_officer'      , 14 ,        6,          7 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    ...
    Label(  'vehicle.car'                          , 18 ,        17,         8 , 'vehicle'         , 7       , True         , False        , (  0,  0,142) ),
    Label(  'vehicle.emergency.ambulance'          , 19 ,        19,         8 , 'vehicle'         , 7       , True         , False        , (  0,  0,142) ),
    Label(  'vehicle.emergency.police'             , 20 ,        19,         8 , 'vehicle'         , 7       , True         , False        , (  0,  0,142) ),
    Label(  'vehicle.truck'                        , 21 ,        23,         9 , 'vehicle'         , 7       , True         , False        , (  0,  0, 70) ),
    Label(  'vehicle.bus.bendy'                    , 22 ,        15,        10 , 'vehicle'         , 7       , True         , False        , (  0, 60,100) ),
    Label(  'vehicle.bus.rigid'                    , 23 ,        16,        10 , 'vehicle'         , 7       , True         , False        , (  0, 60,100) ),
    Label(  'vehicle.construction'                 , 24 ,        18,        11 , 'vehicle'         , 7       , True         , False        , (  80, 100, 200) ),
    Label(  'vehcile.trailer'                      , 25 ,        22,       255 , 'vehicle'         , 7       , True         , True         , (  0,  0,110) ),
    Label(  'vehicle.motorcycle'                   , 26 ,        21,        12 , 'vehicle'         , 7       , True         , False        , (  0,  0,230) ),
    Label(  'vehicle.bicycle'                      , 27 ,        14,        13 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
