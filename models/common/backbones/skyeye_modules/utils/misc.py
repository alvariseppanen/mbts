...
from po_bev_unsupervised.modules.batch_norm import RegularBatchNorm2d, RegularBatchNorm3d

from po_bev_unsupervised.modules.misc import ActivatedAffine, ActivatedGroupNorm
# from po_bev_unsupervised.models.backbone.efficientnet_utils import Conv2dDynamicSamePadding, Conv2dStaticSamePadding
...
def norm_act_from_config(body_config):
    ...
    if mode == "bn":
        ...
        norm_act_2d = partial(RegularBatchNorm2d, activation=activation, activation_param=slope)
        norm_act_3d = partial(RegularBatchNorm3d, activation=activation, activation_param=slope)
        norm_act_static = partial(InPlaceABNSync, activation=activation, activation_param=slope)
    else:
