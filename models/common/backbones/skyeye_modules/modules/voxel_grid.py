...
class DenseVoxelGrid(nn.Module):
    ...
    def _make_voxel_index_grid(self):
        ...
        # TODO: CRITICAL
        # ToDo: Division by 4 will cause inconsistent voxel grid scales! The voxel grid is stretched along the y direction as such the projection is not correct anymore
