...
labels_short = [
    ...
    Label(  'rail track'           , 10 ,        10,       255 , 'flat'            , 1       , False        , True         , True         , (230,150,140) ),
    Label(  'building'             , 11 ,        11,         2 , 'construction'    , 2       , True         , False        , False        , ( 70, 70, 70) ),
    Label(  'wall'                 , 12 ,        7 ,         2 , 'construction'    , 2       , False        , False        , False        , (102,102,156) ),
    Label(  'fence'                , 13 ,        8 ,         2 , 'construction'    , 2       , False        , False        , False        , (190,153,153) ),
    Label(  'guard rail'           , 14 ,        30,       255 , 'construction'    , 2       , False        , True         , True         , (180,165,180) ),
    Label(  'bridge'               , 15 ,        31,       255 , 'construction'    , 2       , False        , True         , True         , (150,100,100) ),
    Label(  'tunnel'               , 16 ,        32,       255 , 'construction'    , 2       , False        , True         , True         , (150,120, 90) ),
    Label(  'pole'                 , 17 ,        21,         3 , 'object'          , 3       , True         , False        , True         , (153,153,153) ),
    Label(  'polegroup'            , 18 ,       -1 ,       255 , 'object'          , 3       , False        , True         , True         , (153,153,153) ),
    Label(  'traffic light'        , 19 ,        23,         3 , 'object'          , 3       , True         , False        , True         , (250,170, 30) ),
    Label(  'traffic sign'         , 20 ,        24,         3 , 'object'          , 3       , True         , False        , True         , (220,220,  0) ),
    Label(  'vegetation'           , 21 ,        5 ,         4 , 'nature'          , 4       , False        , False        , False        , (107,142, 35) ),
    Label(  'terrain'              , 22 ,        4 ,         5 , 'nature'          , 4       , False        , False        , False        , (152,251,152) ),
    ...
    Label(  'car'                  , 26 ,        13,         7 , 'vehicle'         , 7       , True         , False        , False        , (  0,  0,142) ),
    Label(  'truck'                , 27 ,        14,         8 , 'vehicle'         , 7       , True         , False        , False        , (  0,  0, 70) ),
    Label(  'bus'                  , 28 ,        34,         8 , 'vehicle'         , 7       , True         , False        , False        , (  0, 60,100) ),
    Label(  'caravan'              , 29 ,        16,       255 , 'vehicle'         , 7       , True         , True         , True         , (  0,  0, 90) ),
    Label(  'trailer'              , 30 ,        15,       255 , 'vehicle'         , 7       , True         , True         , True         , (  0,  0,110) ),
    Label(  'train'                , 31 ,        33,       255 , 'vehicle'         , 7       , True         , False        , False        , (  0, 80,100) ),
    Label(  'motorcycle'           , 32 ,        17,         9 , 'vehicle'         , 7       , True         , False        , False        , (  0,  0,230) ),
    Label(  'bicycle'              , 33 ,        18,         9 , 'vehicle'         , 7       , True         , False        , False        , (119, 11, 32) ),
    Label(  'garage'               , 34 ,        12,         2 , 'construction'    , 2       , True         , True         , True         , ( 64,128,128) ),
    Label(  'gate'                 , 35 ,        6 ,         4 , 'construction'    , 2       , False        , True         , True         , (190,153,153) ),
    Label(  'stop'                 , 36 ,        29,       255 , 'construction'    , 2       , True         , True         , True         , (150,120, 90) ),
    Label(  'smallpole'            , 37 ,        22,         5 , 'object'          , 3       , True         , True         , True         , (153,153,153) ),
...
labels_3 = [
    ...
    Label(  'parking'              ,  9 ,        2 ,       255 , 'flat'            , 1       , False        , True         , True         , (250,170,160) ),
    Label(  'rail track'           , 10 ,        10,       255 , 'flat'            , 1       , False        , True         , True         , (230,150,140) ),
    Label(  'building'             , 11 ,        11,         2 , 'construction'    , 2       , False         , False       , True          , ( 70, 70, 70) ),
    Label(  'wall'                 , 12 ,        7 ,         2 , 'construction'    , 2       , False        , False        , True         , (102,102,156) ),
    Label(  'fence'                , 13 ,        8 ,         2 , 'construction'    , 2       , False        , False        , True         , (190,153,153) ),
    Label(  'guard rail'           , 14 ,        30,       255 , 'construction'    , 2       , False        , True         , True         , (180,165,180) ),
    Label(  'bridge'               , 15 ,        31,       255 , 'construction'    , 2       , False        , True         , True         , (150,100,100) ),
    Label(  'tunnel'               , 16 ,        32,       255 , 'construction'    , 2       , False        , True         , True         , (150,120, 90) ),
    Label(  'pole'                 , 17 ,        21,       255 , 'object'          , 3       , False         , False        , True         , (153,153,153) ),
    Label(  'polegroup'            , 18 ,       -1 ,       255 , 'object'          , 3       , False        , True         , True         , (153,153,153) ),
    Label(  'traffic light'        , 19 ,        23,       255 , 'object'          , 3       , False         , False        , True         , (250,170, 30) ),
    Label(  'traffic sign'         , 20 ,        24,       255 , 'object'          , 3       , False         , False        , True         , (220,220,  0) ),
    Label(  'vegetation'           , 21 ,        5 ,       255 , 'nature'          , 4       , False        , False        , True         , (107,142, 35) ),
    Label(  'terrain'              , 22 ,        4 ,         3 , 'nature'          , 4       , False        , False        , True         , (152,251,152) ),
    Label(  'sky'                  , 23 ,        9 ,       255 , 'sky'             , 5       , False        , False        , True         , ( 70,130,180) ),
    Label(  'person'               , 24 ,        19,         4 , 'human'           , 6       , True         , False        , True         , (220, 20, 60) ),
    Label(  'rider'                , 25 ,        20,         5 , 'human'           , 6       , True         , False        , True         , (255,  0,  0) ),
    Label(  'car'                  , 26 ,        13,         6 , 'vehicle'         , 7       , True         , False        , True         , (  0,  0,142) ),
    Label(  'truck'                , 27 ,        14,         7 , 'vehicle'         , 7       , True         , False        , True         , (  0,  0, 70) ),
    Label(  'bus'                  , 28 ,        34,         7 , 'vehicle'         , 7       , True         , False        , True         , (  0, 60,100) ),
    Label(  'caravan'              , 29 ,        16,       255 , 'vehicle'         , 7       , False        , True         , True         , (  0,  0, 90) ),
    Label(  'trailer'              , 30 ,        15,       255 , 'vehicle'         , 7       , False        , True         , True         , (  0,  0,110) ),
    Label(  'train'                , 31 ,        33,       255 , 'vehicle'         , 7       , False        , False        , True         , (  0, 80,100) ),
    Label(  'motorcycle'           , 32 ,        17,         5 , 'vehicle'         , 7       , True         , False        , True         , (  0,  0,230) ),
    Label(  'bicycle'              , 33 ,        18,         5 , 'vehicle'         , 7       , True         , False        , True         , (119, 11, 32) ),
    Label(  'garage'               , 34 ,        12,         2 , 'construction'    , 2       , False         , False       , True          , ( 70,70, 70) ),
    Label(  'gate'                 , 35 ,        6 ,         2 , 'construction'    , 2       , False        , False        , True         , (190,153,153) ),
    Label(  'stop'                 , 36 ,        29,       255 , 'construction'    , 2       , False        , True         , True         , (150,120, 90) ),
    Label(  'smallpole'            , 37 ,        22,       255 , 'object'          , 3       , False        , False        , True         , (153,153,153) ),
    Label(  'lamp'                 , 38 ,        25,       255 , 'object'          , 3       , False        , False        , True         , (0,   64, 64) ),
    Label(  'trash bin'            , 39 ,        26,       255 , 'object'          , 3       , False        , False        , True         , (0,  128,192) ),
    Label(  'vending machine'      , 40 ,        27,       255 , 'object'          , 3       , False        , False        , True         , (128, 64,  0) ),
    Label(  'box'                  , 41 ,        28,       255 , 'object'          , 3       , False        , False        , True         , (64,  64,128) ),
    Label(  'unknown construction' , 42 ,        35,       255 , 'void'            , 0       , False        , True         , True         , ( 0,  0,  0) ),
    Label(  'unknown vehicle'      , 43 ,        36,       255 , 'void'            , 0       , False        , True         , True         , ( 0,  0, 0) ),
    Label(  'unknown object'       , 44 ,        37,       255 , 'void'            , 0       , False        , True         , True         , ( 0, 0, 0) ),
    Label(  'license plate'        , -1 ,        -1,        -1 , 'vehicle'         , 7       , False        , True         , True         , (  0,  0,142) ),
]
